		...
		<>
			...
			<div className='section'>
				<div className='fixed'>
					...
					<p className='about-content'>
						<Tooltip word={'Process Scheduling'} info={1} /> is an OS task that
						schedules processes of different states like ready, waiting, and
						running. Process scheduling allows OS to allocate a time interval of
						CPU execution for each process. Another important reason for using a
						process scheduling system is that it keeps the CPU busy all the
						time. This allows you to get the minimum response time for programs.
					</p>
				</div>
