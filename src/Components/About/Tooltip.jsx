			...
			case 1:
				return (
					<React.Fragment>
						<ul>
							<li>
								<Typography color='inherit'>FCFS</Typography>
							</li>
							<li>
								<Typography color='inherit'>SJF</Typography>
							</li>
							<li>
								<Typography color='inherit'>Priority Scheduling</Typography>
							</li>
							<li>
								<Typography color='inherit'>Round Robin Scheduling</Typography>
							</li>
						</ul>
					</React.Fragment>
				);
